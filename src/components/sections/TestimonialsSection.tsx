...
const fallbackTestimonials: Review[] = [
  { id: "fb-1", name: "Sarah Mitchell", company: "Luxe Skincare Co.", star_rating: 5, message: "Working with this team transformed our entire business. Our conversion rate jumped 180% in just 3 months. The attention to detail and strategic thinking is unmatched.", is_featured: true, created_at: new Date().toISOString() },
  { id: "fb-2", name: "Marcus Chen", company: "Urban Threads", star_rating: 5, message: "From day one, I knew I was working with a true expert. The store exceeded all my expectations and we hit $2.4M in our first year. Best investment I've ever made.", is_featured: true, created_at: new Date().toISOString() },
  { id: "fb-3", name: "Emily Rodriguez", company: "Peak Performance Gear", star_rating: 5, message: "The 3D product visualization feature alone increased our average order value by 245%. This isn't just design work — it's revenue engineering.", is_featured: true, created_at: new Date().toISOString() },
  { id: "fb-4", name: "David Park", company: "Artisan Home Goods", star_rating: 5, message: "Our mobile conversions went up 320% after the redesign. The AR furniture preview feature is something our customers absolutely love.", is_featured: true, created_at: new Date().toISOString() },
  { id: "fb-5", name: "Jasmine Patel", company: "Bloom & Wilder", star_rating: 5, message: "Within 60 days our email revenue tripled. The Klaviyo flows are buttery smooth and our subscribers actually open them.", is_featured: false, created_at: new Date().toISOString() },
  { id: "fb-6", name: "Ahmed Khalil", company: "Nordstone Watches", star_rating: 5, message: "Premium feel from header to checkout. AOV went from $89 to $214. The team handled every detail without hand-holding.", is_featured: false, created_at: new Date().toISOString() },
  { id: "fb-7", name: "Olivia Bennett", company: "Coastal Apparel", star_rating: 5, message: "Best ROI we've ever paid for. Sales doubled in the first month after launch and our return rate dropped.", is_featured: false, created_at: new Date().toISOString() },
  { id: "fb-8", name: "Ravi Shankar", company: "GreenPulse Supplements", star_rating: 5, message: "The AI commercial videos brought a whole new energy to our paid ads. CPM dropped 40% and CTR doubled.", is_featured: false, created_at: new Date().toISOString() },
  { id: "fb-9", name: "Sophie Laurent", company: "Maison Étoile", star_rating: 5, message: "Elegant, fast, and conversion-obsessed. Exactly what a luxury Shopify store should feel like.", is_featured: false, created_at: new Date().toISOString() },
  { id: "fb-10", name: "Tomás García", company: "Andina Coffee Co.", star_rating: 5, message: "We finally have a store that matches the quality of our beans. Subscriptions grew 4x in 3 months.", is_featured: false, created_at: new Date().toISOString() },
  { id: "fb-11", name: "Naomi Sato", company: "Hikari Beauty", star_rating: 5, message: "Loved the strategy-first approach. Every section had a reason and the numbers proved it. +212% revenue YoY.", is_featured: false, created_at: new Date().toISOString() },
  { id: "fb-12", name: "Liam Foster", company: "Trailhead Outdoors", star_rating: 5, message: "Communication was world-class. Delivered on time, on budget, and our launch day broke our previous monthly record.", is_featured: false, created_at: new Date().toISOString() },
];
